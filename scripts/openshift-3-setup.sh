...
sudo su -
set -o vi
subscription-manager register --username ${RHEL-SUB-USER} --password ${RHEL-SUB-PASS}
subscription-manager list --available --matches '*OpenShift*'
# Available:           Unlimited
# System Type:         Virtual
subscription-manager attach --pool=${RHEL-SUB-POOL}
...
yum -y update
yum -y install atomic-openshift-clients openshift-ansible vim
...
#set -o vi
#eval $(ssh-agent -s)
# Need to scp trace3.pem private key to run ansible...
#ssh-add /home/ec2-user/trace3.pem
#ansible-playbook -i /home/ec2-user/inventory_aio /usr/share/ansible/openshift-ansible/playbooks/prerequisites.yml
#ansible-playbook -i /home/ec2-user/inventory_aio /usr/share/ansible/openshift-ansible/playbooks/deploy_cluster.yml
